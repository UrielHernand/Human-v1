  ...
  const showDepartments = () => {
    return departamentosData.map((dep) => (
        ...
        <Card elevation={5} style={{ borderRadius: '15px' }}>
          <CardMedia component="img" height="150" image={dep.imagen} alt={dep.nombre} />
          <CardContent>
    ...
    <div style={{ background: '#f9f9f9' }}>
      <Container>
        <Dialog open={isDialogOpen} onClose={() => setIsDialogOpen(false)}>
          ...
          <DialogContent>
            <DialogContentText>
              Antes de continuar, deberá configurar su departamento de Recursos Humanos.
            </DialogContentText>
          </DialogContent>
          <DialogActions>
      ...
      <Container>
        ...
        {isEditing ? (
          ...
          <Grid container spacing={2}>{showDepartments()}</Grid>
        )}
        <hr />
      </Container>
    </div>
